...
function nllz() {
    ...
    document.getElementById("nllz05").value = ((parseFloat(a) + parseFloat(d))/40).toFixed(1);
    document.getElementById("nllz06").value = ((parseFloat(a) + parseFloat(c))/40).toFixed(1);
    document.getElementById("nllz07").value = ((parseFloat(b) + parseFloat(d))/40).toFixed(1);
    document.getElementById("nllz08").value = ((parseFloat(b) + parseFloat(c))/40).toFixed(1);
...
function nlly() {
    ...
    document.getElementById("nlly05").value = ((parseFloat(a) + parseFloat(c))/40).toFixed(1);
    document.getElementById("nlly06").value = ((parseFloat(a) + parseFloat(d))/40).toFixed(1);
    document.getElementById("nlly07").value = ((parseFloat(b) + parseFloat(c))/40).toFixed(1);
    document.getElementById("nlly08").value = ((parseFloat(b) + parseFloat(d))/40).toFixed(1);
